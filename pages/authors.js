  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="card-text bold">${item.favorite ? '<span class="badge badge-info sale-badge"><i class="fa fa-bell" aria-hidden="true"></i> Favorite</span> Author' : 'Author'}</p>
        <hr>
        <i class="btn btn-success fas fa-eye" id="view-author-btn--${item.firebaseKey}">View</i>
        <i class="fas fa-edit btn btn-info" id="update-author--${item.firebaseKey}">Update Info</i>
